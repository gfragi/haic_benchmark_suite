...
# def calculate_prediction_accuracy(interaction_data):
#     """
#     Calculates the prediction accuracy based on the true positives and true negatives.
#     """
#     tp = sum(1 for item in interaction_data if item.get("ai_detection_results") == "true_positive")
#     tn = sum(1 for item in interaction_data if item.get("ai_detection_results") == "true_negative")
#     total = len(interaction_data)
#     return (tp + tn) / total if total > 0 else 0
...
def calculate_human_ai_agreement_rate(interaction_data):
    """
    Calculates the agreement rate between human decisions and AI suggestions.
    """
...
def calculate_time_to_resolution(interaction_data):
    """
    Calculates the average time to resolve issues.
    """
...
def calculate_human_effort_saved(interaction_data):
    """
    Calculates the human effort saved due to AI assistance.
    """
...
def calculate_ai_assistance_rate(interaction_data):
    """
    Calculates the rate at which AI assisted human decisions.
    """
...
def calculate_learning_efficiency(interaction_data):
    """
    Calculates the efficiency of human learning with AI assistance.
    """
...
def get_available_metrics():
    metrics_map = {
        ...
        # Aggregated Metrics
        "Correction Efficiency": calculate_correction_efficiency,
        "Learning Efficiency": calculate_learning_efficiency,
        "AI Assistance Rate": calculate_ai_assistance_rate,
        "Human Effort Saved": calculate_human_effort_saved,
        "Time to Resolution": calculate_time_to_resolution,
        "Human-AI Agreement Rate": calculate_human_ai_agreement_rate,
